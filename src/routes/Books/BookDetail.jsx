...
const BookDetail = () => {
  ...
  const checkFavoriteStatus = async () => {
    try {
      ...
      const bookmarkResponse = await api.get(
        `${process.env.REACT_APP_SERVER_URL}/bookmarks/list`,
        {
          params: { userId },
        }
      );
  ...
  const handleAddBookmark = async () => {
    ...
    try {
      await api.post(
        `${process.env.REACT_APP_SERVER_URL}/bookmarks/addBook`,
        null,
        {
  ...
  const handleRemoveBookmark = async () => {
    ...
    try {
      await api.delete(`${process.env.REACT_APP_SERVER_URL}/bookmarks/remove`, {
        params: { userId, bookId: bookId },
      });
      setIsFavorite(false);
    } catch (error) {
